...
const Sidebar = ({ SidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <div
      className={`flex flex-col justify-between w-60 xl:w-72 bg-white border-r border-gray-200 items-center max-sm:absolute top-0 bottom-0 z-10 ${
    ...
    <div>
      ...
      gap-2 py-2.5 mt-6 mx-6 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-700 
