import { ArrowLeft, Type, Image,TextIcon, Upload, Sparkle } from 'lucide-react'
  ...
  return (
    ...
    backdrop-blur text-white flex items-center justify-center p-4">
      <div className='w-full max-w-sm'>
        ...
        <div className="rounded-lg h-80 flex items-center justify-center relative" style={{backgroundColor: background}}>
          {mode==='text'  && (
        ...
        })}  className="flex items-center justify-center gap-2 text-white py-3 mt-3 w-full 
