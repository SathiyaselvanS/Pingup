                                    ...
                                    bg-black overflow-hidden'>
                                        {
                                            ...
                                            transition duration-500 opacity-70 hover:opacity-90" />:
                                            <video src={story.media_url} className='className="h-full w-full object-cover hover:scale-110 
